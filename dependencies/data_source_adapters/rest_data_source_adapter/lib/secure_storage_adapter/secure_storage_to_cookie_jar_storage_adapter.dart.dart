...
class SecureStorageToCookieJarStorageAdapter implements Storage {
  // @override
  ...
  SecureStorageToCookieJarStorageAdapter([this.dir]) : shouldCreateDirectory = true;

  // @visibleForTesting
  SecureStorageToCookieJarStorageAdapter.test(this.dir, {this.shouldCreateDirectory = false});
